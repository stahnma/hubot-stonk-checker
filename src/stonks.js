...
env = process.env
var apiKey = process.env.HUBOT_FINNHUB_API_KEY
var memeset = process.env.HUBOT_MEMESTONKS
const default_meme_set = "AMC,BB,BBBY,DOGE-USD,GME"
var richtext

if(memeset === undefined)
  memeset = default_meme_set.split(',');
else
